...
//        let documentsURL = documentsDirectory as! NSURL
////        let documentDirectory = NSSearchPathForDirectoriesInDomains(.DocumentDirectory, .UserDomainMask, true).first! as NSURL
////        let localPath = documentDirectory.stringByAppendingPathComponent(imageName!)
//        
//        
//        let localPath = documentsURL
